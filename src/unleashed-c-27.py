...
"""
Unleashed - v00027
- New: Auto-config from .unleashed.json — reads repo config for model/effort (#57)
- New: Auto-pickup — --pickup flag sends /pickup to Claude after initial prompt (#68)
- Carries forward all v26 features: per-repo session logs, tab focus-back, console tab,
  telemetry hooks, auto-tab-naming, typeahead dedup, thinking animation filter,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=f"Unleashed v{VERSION} — Auto-Config + Auto-Pickup + Per-Repo Logs + Telemetry + Sentinel")
